...
class MovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movement" do
    assert_difference("Movement.count") do
      post movements_url, params: { movement: { name: @movement.name, notes: @movement.notes, work: @movement.work } }
    end
  ...
  test "should update movement" do
    patch movement_url(@movement), params: { movement: { name: @movement.name, notes: @movement.notes, work: @movement.work } }
